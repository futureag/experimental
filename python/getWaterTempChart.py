...
def getTempChart():
    r = requests.get('http://127.0.0.1:5984/mvp_sensor_data/_design/doc/_view/attribute_value?startkey=["water temperature",{}]&endkey=["water temperature"]&descending=true&limit=60')
    print r
    ...
    line_chart.title = 'Water Temperature'
    ...
    #need to reverse order to go from earliest to latest
    v_lst.reverse()
    line_chart.add('Water Temp', v_lst)
    line_chart.render_to_file('/home/pi/MVP/web/water_temp_chart.svg')
